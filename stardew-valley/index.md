...
|---|---|---|
| ![](./resource-crops.png) **Crops** | Parsnip, Potato | ปลูกในนา |
| ![](./resource-forageables.png) **Forageables** | Horseradish, Daffodil | เก็บระหว่างเดิน |
| ![](./resource-fish.png) **Fish** | Halibut, Catfish | ตกปลา |
| ![](./resource-animal-products.png) **Animal Products** | Milk, Egg | เลี้ยงสัตว์ |
| ![](./resource-ore.png) **Ore** | Copper, Iron | เหมือง |
| ![](./resource-geodes.png) **Geodes** | Geode ชนิดต่างๆ | เหมือง |
| ![](./resource-minerals.png) **Minerals** | Ghost Crystal | เปิด Geode |
| ![](./resource-artifacts.png) **Artifacts** | Palm Fossil | เปิด Geode |
...
![](./resource-materials.png) **Materials** (Stone, Wood, Fiber) — ใช้สร้าง Building เท่านั้น

![](./resource-trash.png) **Trash** — ไม่มีประโยชน์ ทิ้งเมื่อไรก็ได้

![](./resource-bug-meat.png) **Monster Loot / Bug Meat** — ใช้จับ Crab Pot Fish
...
> ระหว่างเดิน (แบบ B เท่านั้น) หยิบ ![](./symbol-forageable.png) Forageable หรือ Tree tile ฟรี 1 อัน
...
|---|---|---|
| ![](./symbol-shipping.png) **Shipping Bin** | กล่องขนส่ง | ทีมขายของได้โดยไม่เสีย Action |
| ![](./symbol-gift.png) **Gift** | กล่องของขวัญ | ทุกคนใช้ Gift Ability ของ Villager เพื่อนตัวเอง |
| ![](./symbol-cat.png) **Pet Wanders** | หน้าแมว/หมา | Starting Player ส่ง Pet Token ไปคนถัดไป |
| ![](./symbol-crow-green.png) **Green Crow** | กาสีเขียว | ทิ้ง Crop 1 ต้นในนาสีเขียว |
...
### ![](./action-water-crops.png) Water Crops
...
### ![](./action-collect-animals.png) Collect from Animals
...
### ![](./action-buy-seeds.png) Buy & Plant Seeds *(Pierre's)*
...
*(ขายได้ฟรีเมื่อ Season Card แสดง ![](./symbol-shipping.png))*

---

### ![](./action-make-friend.png) Make a Friend *(Town)*

พลิก Villager Card บนสุด → ถ้าอยากเป็นเพื่อน ให้ของ 1 อัน รับ Hearts เก็บไพ่ไว้

![](./diagram-villager-card.png)

![](./diagram-gift-hearts.png)

**ของที่ให้ไม่ได้ (ทุก Villager):** Trash, Stone, Bug Meat, ของที่มี No Gift icon

**Gift Ability:**
เมื่อ Season Card แสดง ![](./symbol-gift.png) → ทุกคนเลือก Villager เพื่อนของตัวเอง 1 คน ใช้ Gift Ability บนไพ่

---

### ![](./action-bundles.png) Reveal & Donate to Bundles *(Community Center)*
...
### ![](./action-buy-animals.png) Buy Animals *(Marnie's Ranch)*

![](./diagram-animal-tile.png)
...
### ![](./action-mine.png) Explore the Mine

ทอย **Stardew Dice 2 ลูก** → เลือกว่าลูกไหนเป็นแถว ลูกไหนเป็นคอลัมน์ → ดูผลจาก Map Card

![](./diagram-map-card.png)

| ผล | ทำอะไร |
|---|---|
| ![](./item-stone.png) Stone | รับ Stone tile |
...
| Item | รับ Item Card |
| ![](./item-monster.png) Monster | ทำตาม Monster Ability บน Mine Level Card |
| Mine Event | จั่ว Mine Event Card |

**Mine Level Cards:**

![](./diagram-mine-level.png)
...
### ![](./action-buy-buildings.png) Buy Buildings *(Robin's)*

![](./diagram-building-tile.png)
...
### ![](./action-open-geodes.png) Open Geodes *(Clint's)*
...
### ![](./action-donate-museum.png) Donate to Museum *(Gunther's)*
...
|---|---|---|
| ![](./action-fishing-river.png) **River** | สามเหลี่ยม | ปลาน้ำจืด |
| ![](./action-fishing-ocean.png) **Ocean** | สี่เหลี่ยม | ปลาทะเล |
| ![](./action-fishing-lake.png) **Lake** | วงกลม | ปลาทะเลสาบ |

ทอย **Stardew Dice 3 ลูก** → ได้สัญลักษณ์ 3 อัน: ![](./dice-heart.png) Heart, ![](./dice-junimo.png) Junimo, ![](./dice-stardrop.png) Stardrop

ดู Fish Track — ปลาแต่ละตัวแสดงสัญลักษณ์ที่ต้องการ ถ้าตรง → รับปลา

![Fish Track — ปลาทุกชนิดพร้อม dice symbols ที่ต้องการ](./diagram-fish-track.png)

![ตัวอย่าง Fish Track — ปลาแต่ละตัวอยู่ที่ location ไหนบ้าง](./diagram-fish-track-example.png)
...
| ![](./item-treasure-chest.png) **Treasure Chest** | จับปลาซ้ายมือ Chest tile | รับ Item Card ทันที |
...
ทิ้ง ![](./item-stone.png) Stone จำนวนเท่ากับจำนวนผู้เล่น → ลงเหมือง 1 ชั้น
...
### ![](./item-happy-animal.png) Pet Animals
...
### ![](./item-joja-removed.png) Remove Joja
