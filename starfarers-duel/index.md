...
![Full Setup + Turn Overview](./sfd-04.jpg)
...
**Trade Planet** และ **Outpost** ต่างกันอย่างไร?

| | Trade Planet | Outpost |
|---|---|---|
| **ซื้อ/ขายอะไรได้** | เฉพาะ Resource/Tech ที่แสดงบนการ์ด | **Resource ใดก็ได้** (หรือ Tech) ตามที่ icon ระบุ |
| **ราคา** | ตามที่พิมพ์บนการ์ด (แตกต่างกัน) | **3 Astro** เสมอ |
| **จำนวน** | ซื้อ/ขายกี่อันก็ได้ (ไม่มีลิมิต) | จำกัด **1x หรือ 2x** ต่อ Action |
| **ทิศทาง** | ซื้อ **และ** ขายได้ทั้งคู่ | บางอันทำได้แค่ **ซื้อ** (ดูสัญลักษณ์ลูกศร) |
| **นับเป็น** | **1 Action** (ไม่ว่าจะซื้อขายกี่อัน) | **1 Action** (ไม่ว่าจะทำ 1x หรือ 2x) |

**อ่าน Outpost ยังไง:**
- ลูกศร **↕ (ขึ้นลง)** = ซื้อหรือขายก็ได้
- ลูกศร **↑ (ขึ้นอย่างเดียว)** = ซื้อได้อย่างเดียว
- ตัวเลข **1x / 2x** = ทำได้กี่ครั้งใน Action นั้น

**ตัวอย่าง Outpost:**
> "Sell any 1 resource for 3 Astro up to 2x"
> = ขาย Resource ใดก็ได้ ครั้งละ 3 Astro ทำได้ 2 ครั้งใน Action เดียว (นับเป็น 1 Action)

---

**ต่างกันอีกใน Trade & Build Phase** (ตอนใช้ Trade Station ที่สร้างไว้แล้ว):
- **Planet Trade Station** → ซื้อ/ขายได้ไม่จำกัดจำนวน
- **Outpost Trade Station** → จำกัดตามลูกศรและ 1x/2x บนการ์ดนั้น

---

### Establish a Trade Station

![Trade Station, Colony, Mission](./sfd-07.jpg)
...
![Pirate Card — annotated](./sfd-pirate-card.png)
